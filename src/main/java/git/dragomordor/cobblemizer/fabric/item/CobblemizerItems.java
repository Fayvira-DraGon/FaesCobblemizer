...
public class CobblemizerItems {
  ...
  //ShinyCapsuleItem
  public static final ShinyCapsuleItem SHINY_CAPSULE = registerShinyCapsuleItem("shiny_capsule", new ShinyCapsuleItem());
  ...
  // NatureChangerItem
  public static final NatureChangerItem NATURE_CHANGER_ADAMANT = registerNatureChangerItem("nature_changer_adamant", new NatureChangerItem(Natures.ADAMANT));
  public static final NatureChangerItem NATURE_CHANGER_BASHFUL = registerNatureChangerItem("nature_changer_bashful", new NatureChangerItem(Natures.BASHFUL));
  public static final NatureChangerItem NATURE_CHANGER_BOLD = registerNatureChangerItem("nature_changer_bold", new NatureChangerItem(Natures.BOLD));
  public static final NatureChangerItem NATURE_CHANGER_BRAVE = registerNatureChangerItem("nature_changer_brave", new NatureChangerItem(Natures.BRAVE));
  public static final NatureChangerItem NATURE_CHANGER_CALM = registerNatureChangerItem("nature_changer_calm", new NatureChangerItem(Natures.CALM));
  public static final NatureChangerItem NATURE_CHANGER_CAREFUL = registerNatureChangerItem("nature_changer_careful", new NatureChangerItem(Natures.CAREFUL));
  public static final NatureChangerItem NATURE_CHANGER_DOCILE = registerNatureChangerItem("nature_changer_docile", new NatureChangerItem(Natures.DOCILE));
  public static final NatureChangerItem NATURE_CHANGER_GENTLE = registerNatureChangerItem("nature_changer_gentle", new NatureChangerItem(Natures.GENTLE));
  public static final NatureChangerItem NATURE_CHANGER_HARDY = registerNatureChangerItem("nature_changer_hardy", new NatureChangerItem(Natures.HARDY));
  public static final NatureChangerItem NATURE_CHANGER_HASTY = registerNatureChangerItem("nature_changer_hasty", new NatureChangerItem(Natures.HASTY));
  public static final NatureChangerItem NATURE_CHANGER_IMPISH = registerNatureChangerItem("nature_changer_impish", new NatureChangerItem(Natures.IMPISH));
  public static final NatureChangerItem NATURE_CHANGER_JOLLY = registerNatureChangerItem("nature_changer_jolly", new NatureChangerItem(Natures.JOLLY));
  public static final NatureChangerItem NATURE_CHANGER_LAX = registerNatureChangerItem("nature_changer_lax", new NatureChangerItem(Natures.LAX));
  public static final NatureChangerItem NATURE_CHANGER_LONELY = registerNatureChangerItem("nature_changer_lonely", new NatureChangerItem(Natures.LONELY));
  public static final NatureChangerItem NATURE_CHANGER_MILD = registerNatureChangerItem("nature_changer_mild", new NatureChangerItem(Natures.MILD));
  public static final NatureChangerItem NATURE_CHANGER_MODEST = registerNatureChangerItem("nature_changer_modest", new NatureChangerItem(Natures.MODEST));
  public static final NatureChangerItem NATURE_CHANGER_NAIVE = registerNatureChangerItem("nature_changer_naive", new NatureChangerItem(Natures.NAIVE));
  public static final NatureChangerItem NATURE_CHANGER_NAUGHTY = registerNatureChangerItem("nature_changer_naughty", new NatureChangerItem(Natures.NAUGHTY));
  public static final NatureChangerItem NATURE_CHANGER_QUIET = registerNatureChangerItem("nature_changer_quiet", new NatureChangerItem(Natures.QUIET));
  public static final NatureChangerItem NATURE_CHANGER_QUIRKY = registerNatureChangerItem("nature_changer_quirky", new NatureChangerItem(Natures.QUIRKY));
  public static final NatureChangerItem NATURE_CHANGER_RASH = registerNatureChangerItem("nature_changer_rash", new NatureChangerItem(Natures.RASH));
  public static final NatureChangerItem NATURE_CHANGER_RELAXED = registerNatureChangerItem("nature_changer_relaxed", new NatureChangerItem(Natures.RELAXED));
  public static final NatureChangerItem NATURE_CHANGER_SASSY = registerNatureChangerItem("nature_changer_sassy", new NatureChangerItem(Natures.SASSY));
  public static final NatureChangerItem NATURE_CHANGER_SERIOUS = registerNatureChangerItem("nature_changer_serious", new NatureChangerItem(Natures.SERIOUS));
  public static final NatureChangerItem NATURE_CHANGER_TIMID = registerNatureChangerItem("nature_changer_timid", new NatureChangerItem(Natures.TIMID));
